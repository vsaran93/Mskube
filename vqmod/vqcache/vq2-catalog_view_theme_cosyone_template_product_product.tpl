  ...
  <div class="product-info">
   ...
   <div class="right" style="margin-<?php if ($direction == 'rtl') { echo 'right'; } else { echo 'left'; } ?>:<?php echo $thumb_width; ?>px">
      ...
      <?php } ?>
       ...
       <div id="product">
       Payment Type: <img src="image/catalog/Capture2.PNG"/></br> </br>
	      
     <table class="table table-hover">
	 <tr>
	 <td>
	 Shipping Method: (Royal Mail)   <img src="royalmail.png" width="40px"/>
	 </td>
	 <td>
	 Shipping Cost: <strong>£3.35</strong></br> </br>
	 </td>
