...
<title>Girls party wear | Girls occasion wear | Girls clothing | MSKUBE</title>
...
<?php if($cosyone_header_style == 'header1'){ ?>
  ...
  <div class="links contrast_font">
   ...
   <a href="#"> Tel: +441604648093</a>
    <a href="http://mskube.com/index.php?route=information/information&information_id=7"> FAQ</a>
